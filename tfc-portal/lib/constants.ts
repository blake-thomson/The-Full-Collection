...
export const ROLE_META: Record<string, { label: string; color: string; emoji: string; welcomeLine: string }> = {
  ...
  youtube_editor: { label: "YouTube Editor", color: "#10B981", emoji: "🎬", welcomeLine: "You bring the long-form vision to life. Let's get your profile set up." },
  short_form_editor: { label: "Short Form Editor", color: "#06B6D4", emoji: "📱", welcomeLine: "You make the short-form magic happen. Let's get your profile set up." },
