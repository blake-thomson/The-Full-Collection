...
> = {
  instagram: {
    ...
    scopes: "instagram_basic,instagram_content_publish,instagram_manage_insights,instagram_manage_comments,pages_read_engagement,pages_show_list,pages_manage_posts,business_management",
