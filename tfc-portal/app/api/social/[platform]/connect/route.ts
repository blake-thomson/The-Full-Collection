...
> = {
  instagram: {
    ...
    scopes: "instagram_basic,instagram_content_publish,instagram_manage_comments,read_insights,pages_read_engagement,pages_show_list,pages_manage_posts,business_management",
